...
pw.println("<h3>Employee(Delete module)</h3>");
...
pw.println("<td style='text-align:center'><a href='/styleone/deleteEmployee?employeeId="+employee.getEmployeeId()+"'>Delete</a></td>");
pw.println("</tr>");
j++;
}
pw.println("</tbody>");
